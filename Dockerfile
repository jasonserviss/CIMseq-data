...
RUN Rscript -e "source('source('https://raw.githubusercontent.com/jasonserviss/install/master/install_cran.R');install_cran(c('openxlsx/4.0.17', 'googledrive/0.1.1', 'dplyr/0.7.7', 'stringr/1.3.1', 'tibble/1.4.2', 'readr/1.1.1', 'purrr/0.2.5', 'lubridate/1.7.4', 'rlang/0.2.1', 'readxl/1.1.0', 'tidyr/0.8.1'))"
